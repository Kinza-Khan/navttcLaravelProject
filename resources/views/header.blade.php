...
<body>	
	...
	<div class="header-top">
		...
		<header class="cd-main-header">
			<a class="cd-logo animsition-link" href="/"><img src="images/logo.png" alt="Logo"></a>
			...
			<ul id="cd-primary-nav" class="cd-primary-nav is-fixed">
				...
				<li class="has-children">
					...
					<ul class="cd-nav-gallery is-hidden">
						...
						<li>
							<a class="cd-nav-item animsition-link" href="shop-1">
						...
						<li>
							<a class="cd-nav-item animsition-link" href="shop-2">
						...
						<li>
							<a class="cd-nav-item animsition-link" href="shop-4">
