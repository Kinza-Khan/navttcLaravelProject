			...
			<div class="container">
				...
				<div class="eleven columns">
					<div id="owl-portfolio-slider" class="owl-carousel owl-theme">
						...
						<div class="item">
							<img src="images/portfolio/big/5.jpg" alt="">
							<div class="left-info">INTERACTIVE ELEMENTS</div>
						</div>
						<div class="item">
							<img src="images/portfolio/big/6.jpg" alt="">
							<div class="left-info">AWESOME PORTFOLIOS</div>
						</div>
						<div class="item">
							<img src="images/portfolio/big/7.jpg" alt="">
							<div class="left-info">PARALLAX SUPPORT</div>
						</div>
						<div class="item">
							<img src="images/portfolio/big/8.jpg" alt="">
							<div class="left-info">ENDLESS POSSIBILITIES</div>
						</div>
						<div class="item">
			...
			<div class="container">
				<div class="sixteen columns">
					<div class="blog-left-right-links">
						<a href="fullscreen-project" class="animsition-link"><div class="blog-left-link"><p>prev</p></div></a>
						<a href="video-project" class="animsition-link"><div class="blog-right-link"><p>next</p></div></a>
					</div>
				</div>
			</div>
